...
import industrialImg from '../assets/industrial1.png';
import clinicaImg from '../assets/clinica1.png';
  ...
  return (
    <div className="bg-inusi-light min-h-screen pb-20 overflow-hidden">
      ...
      <div className="relative bg-inusi-blue py-24 text-center text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto font-light">
            Da força industrial à precisão clínica. Tecnologia especializada para cada ecossistema.
          </p>
        </div>
      </div>
      ...
      <section className="py-24 bg-white relative">
        <div className="absolute left-0 top-0 h-full w-20 bg-gray-50 skew-x-12 -ml-10 hidden lg:block"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-inusi-dark mb-6 leading-tight">
                PROTEÇÃO PARA <br /><span className="text-inusi-blue">O SEU NEGÓCIO</span>
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                {["Filtros de Linha Industriais", "Proteção de Racks", "Condicionadores de Energia", "Projetos Sob Medida"].map((item, index) => (
                  <motion.div key={index} whileHover={{ scale: 1.02, x: 5 }} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-100 shadow-sm">
          ...
          <div className="flex flex-col lg:flex-row-reverse gap-16 items-center">
            ...
            >
              <img
                ...
                className="rounded-lg shadow-2xl border border-white/20 relative z-10 w-full object-cover"
              />
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-lg border-t-4 border-inusi-gold">
            <PenTool size={48} className="text-inusi-dark mx-auto mb-6" />
            <h3 className="text-2xl font-heading font-bold text-inusi-dark mb-4">
              Treinamentos e Capacitação
            </h3>
            <p className="text-gray-600 mb-8">
              Compartilhamos nosso conhecimento técnico. Oferecemos cursos e treinamentos para equipes que desejam dominar as normas de segurança elétrica.
            </p>
            <Link to="/contato" className="text-inusi-blue font-bold hover:text-inusi-red hover:underline transition-colors">
              Saiba mais sobre os cursos &rarr;
            </Link>
          </div>
        </div>
      </section>
