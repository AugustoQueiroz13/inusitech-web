...
import protectImg from '../assets/protect1.jpg';
  ...
  const slides = [
    {
      ...
      description: "Sistemas seguros contra surtos e ruídos de rede. Garanta a continuidade da sua produção com tecnologia de ponta.",
    ...
    },
    {
      ...
      description: "Construção eficiente para uso exigente. Filtros de linha e condicionadores que entregam a verdadeira energia limpa.",
      image: protectImg,
      ctaText: "Ver Produtos",
      ctaLink: "/produtos",
      icon: <Zap size={24} />,
      color: "from-inusi-red"
    }
  ];
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`h-1.5 rounded-full transition-all duration-500 ${
              index === currentSlide ? 'bg-inusi-red w-12' : 'bg-gray-400 w-3 hover:bg-white'
            }`}
